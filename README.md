...
This plugin uses [native type stripping](https://nodejs.org/docs/latest-v23.x/api/typescript.html#modules-typescript) with [Node 22.6](https://nodejs.org/pt/blog/release/v22.6.0) and later.
